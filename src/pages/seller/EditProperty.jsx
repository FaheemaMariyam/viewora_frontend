...
//       "furnishing_status","facing","status","is_active",
//     ];
...
//               Update property information carefully
//             </p>
//           </div>
...
//               <Grid>
//                 <Input name="property_age_years" value={form.property_age_years || ""} onChange={handleChange} placeholder="Property Age (Years)" />
//                 <Input name="construction_year" value={form.construction_year || ""} onChange={handleChange} placeholder="Construction Year" />
//                 <Input name="last_renovated_year" value={form.last_renovated_year || ""} onChange={handleChange} placeholder="Last Renovated Year" />
//                 <Input name="ownership_count" value={form.ownership_count || 1} onChange={handleChange} placeholder="Ownership Count" />
//                 <Input name="reason_for_selling" value={form.reason_for_selling || ""} onChange={handleChange} placeholder="Reason for Selling" span />
//               </Grid>
//             </Section>
...
//                 <Textarea name="address" value={form.address || ""} onChange={handleChange} placeholder="Address" span />
...
//       {...props}
//       rows="3"
//       className={`w-full rounded-lg border px-4 py-2 focus:ring-2 focus:ring-indigo-500 outline-none ${span ? "md:col-span-2" : ""}`}
//     />
//   );
// }
