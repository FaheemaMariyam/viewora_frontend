...
export default function Signup() {
  ...
  //     <div className="w-full max-w-md bg-white/90 rounded-2xl p-8 shadow-xl">
  ...
  //       {error && (
  //         <div className="mb-4 text-sm text-red-600 bg-red-50 border px-3 py-2 rounded">
  //           {error}
  //         </div>
  //       )}
  ...
  //             />
  //             <button type="button" onClick={handleVerifyOtp} className="btn bg-green-600">
  //               Verify Phone
  //             </button>
  //           </>
  //         )}
    ...
    <div className="relative w-full max-w-lg
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Join <span className="font-medium text-indigo-700">Viewora</span> to access
      ...
      {/* Error */}
      {error && (
        <div className="mb-6 text-sm text-red-700 bg-red-50
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Seller documents */}
        {role === "seller" && (
          <div className="rounded-xl border border-indigo-200/60
